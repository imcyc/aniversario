                        ...
                        <Col style={{
                            ...
                            <Tab.Content>
                                <Tab.Pane eventKey="first">
                                    <h2 className="text-white"><b><ArrowRight/> INSTITUTO MEXICANO DEL CEMENTO Y DEL CONCRETO A.C.</b></h2>
                                    <hr />
