                    ...
                    <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                        <Col sm={2}>
                            <Nav variant="pills" className="flex-column">
                                <Nav.Item>
                                    <Nav.Link eventKey="first">QUIÉNES SOMOS</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link eventKey="second">SERVICIOS DE LABORATORIO</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link eventKey="third">ASESORÍAS TÉCNICAS</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link eventKey="fifth">CURSOS Y SEMINARIOS</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link eventKey="sixth">PUBLICACIONES</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link eventKey="seventh">BIBLIOTECA</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link eventKey="eigth">CRECIMIENTO SOSTENIDO</Nav.Link>
                                </Nav.Item>
                            </Nav>
                        </Col>
                        <Col>
                            <Tab.Content>
                                <Tab.Pane eventKey="first">
                                    <h1><b>INSTITUTO MEXICANO DEL CEMENTO Y DEL CONCRETO A.C.</b></h1>
                                    <hr />
                                ...
                                <Tab.Pane eventKey="second">
                                    <h1><b>SERVICIOS DE LABORATORIO</b></h1>
                                    <hr />
                                    <p className="text-justify mr-5">La institución cuenta con equipo especializado, personal altamente capacitado y funcionales instalaciones para realizar los estudios de verificación de calidad del concreto en obras y plantas productoras, así como para la evaluación de estructuras dañadas, proyectos de reparación y estudios sobre propiedades físicas, químicas y mecánicas de materiales para construcción.<br /><br />El IMCYC cuenta con cuatro laboratorios especializados: Concreto, Cemento, Metrología y Geotecnia.</p>
                                </Tab.Pane>
                                <Tab.Pane eventKey="third">
                                    <h1><b>ASESORÍAS TÉCNICAS</b></h1>
                                    <hr />
                                ...
                                <Tab.Pane eventKey="eigth">
                                    <h1><b>CRECIMIENTO SOSTENIDO</b></h1>
                                    <hr />
